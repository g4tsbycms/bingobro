   ...
   get fullHistoryDisplay() {
    ...
    if(this.state.showFullCallHistory === true){
      return (
        <div>
          <div className="modal" >
            <h4 className="margin-md">BOLAS SORTEADAS</h4>
            <div className="x-small-text margin-bottom-lg">Ultimas bolas sorteadas</div>
            ...
            <p>
              <button onClick={() => {this.setState({showFullCallHistory:false})}}>Fechar</button>
            </p>
          </div>
      ...
      if(last5Calls.length > 0){
        return (
          <div className="margin-vertical-xlg">
            <h6 className="text-center">CANTADAS</h6>
            ...
            <button className="textOnly x-small-text" onClick={() => {this.setState({showFullCallHistory:true})}}>MOSTRAR TODAS</button>
